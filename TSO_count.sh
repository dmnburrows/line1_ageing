...
#Define paths
data_path="/cndd3/dburrows/DATA/te/rna/aligned.subset.no_TSO/"
...
do 
	...
	do 
        ...
        counts=$(samtools view $data_path/$i-$e | grep -c '$TSO')
        total=$(samtools view -c $data_path/$i-$e)
...
echo 'Done'
 ...
 $(samtools view -c 6285-GLU.subsampled.bam)